[![www.bryan-aguilar.com](./banner_github_profile.png "[www.bryan-aguilar.com](https://www.bryan-aguilar.com)")](https://www.bryan-aguilar.com/)
...
I am a senior software engineer with more than six years of professional experience, currently specializing in fintech infrastructure and transaction systems for the private banking segment. I design and build event-driven microservices that handle real-time card authorization, fraud detection, and automated dispute workflows. I'm actively expanding into AI Engineering, building LLM-powered tools and automated verification systems. I also have a solid background in frontend and mobile development.

⚙ Backend Engineer / event-driven microservices using Node / NestJS / Python / Java <br/>
🤖 AI Engineering / LLM-powered tools using LangGraph / OpenAI API / Claude API <br/>
💻 Frontend & Mobile Developer / React / Next.js / Angular / Flutter <br/>

- Visit my [website](https://www.bryan-aguilar.com/) and see some of my work
- 🔭 I am working at [Karta](https://www.conkarta.com/) as `Senior Software Engineer — Transactions Lead`
...
- [Large Language Model Operations (LLMOps)](https://medium.com/@baguilar6174/large-language-model-operations-llmops-bff993dde6c4)
...
[![Tech Stack](./github_tech_stack.png "[www.bryan-aguilar.com](https://www.bryan-aguilar.com)")](https://www.bryan-aguilar.com/about)
